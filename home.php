...
#cd-vertical-nav i {
 ...
 #cd-vertical-nav a:hover i:hover {
...
<body>
 ...
 <div class="row" >
        ...
        <div class="col m3 offset-m6 s9" style="margin-top:0.7%" align="right">
          <div class="input-field col m5 offset-m4" style="margin-top:-3%">
          <input type="text" placeholder="Search user">
          </div>
          <div class="col m3">
          <a  class="tooltipped waves-effect waves-teal btn-flat-large" name="search" id="search" data-position="bottom" data-tooltip="Search"><span class="white-text"><i class="small material-icons">search</i></span></a>
        </div>
       </div>

				<div class="col m1  s1 offset-s2	" align="right" style="margin-top:0.7%">
  ...
  <div class="DIV_3" id="DIV_3" style="width=100%; position: absolute;	top: 20%">
    <div class="row">
       <div class="col s4 m4">
         <div class="row">
       ...
       <div class="col s5 m5" id="DIV_11" style="margin-top:-5%">
         <div class="transparent white-text">
          <h1 align="center">Friends Bio</h1>
         </div>
       </div>
       <div class="col s3 m3" >
         <div class="row">
...
<div id="cd-vertical-nav">
    	    <ul>
    	  	<li>
    			   <a href="#DIV_1" data-number="1">
    			   	<i class="material-icons medium" id="upper">toll</i>

    			  </a>
    		  </li>
          <li>
             <a href="#ID_2" data-number="2">
               <i class="material-icons medium">toll</i>
            </a>
          </li>
    	</ul>
</div>
